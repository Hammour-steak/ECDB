...
class DenoisingModel(BaseModel):
    def __init__(self, opt):
        ...
        if opt["stage"] == 'train':
            self.model.load_ckpt(opt["unet_pretrained"], mode='train')
            print("Load pretrained Unet from " + opt["unet_pretrained"] + " to train the ControlGOUB")
    ...
    def load(self):
        ...
        if load_path_G is not None:
            ...
            print("Load checkpoint from " + load_path_G + " to evaluate")
